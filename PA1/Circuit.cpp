...
// void Circuit::print_node_info(const NodeID& node_id, string &tmp_string) {
//     if (node_id >= (NodeID) nodes_.size()) {
//         tmp_string.append("Invalid Node ID: ");
//         tmp_string.append(to_string(node_id));
//         tmp_string.append("\nWe only have allocated for ");
//         tmp_string.append(to_string(nodes_.size()));
//         tmp_string.append(" nodes\n");
...
//         tmp_string.append("Invalid Node ID: ");
//         tmp_string.append(to_string(node_id));
//         tmp_string.append("\nDid not parse this Node ID from file\n");
//         return;
//     }
    
//     tmp_string.append(nodes_[node_id]->get_gate_type());
//     tmp_string.append("-n");
//     tmp_string.append(to_string(node_id));
//     tmp_string.append(": ");
//     tmp_string.append(to_string(nodes_[node_id]->gate_slack));
//     tmp_string.append(" ps\n");
//     return;
// }
